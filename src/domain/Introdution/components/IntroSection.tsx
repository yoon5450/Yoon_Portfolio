...
function IntroSection() {
  ...
  return (
    <div
      className="relative py-20 bg-primary-background w-full flex flex-col px-[8%] md:px-10"
      id="about"
    >
      {/* 제목 영역 */}
      ...
      <motion.ul className="grid grid-cols-1 lg:grid-cols-3 justify-items-center lg:gap-20 gap-10 font-[pretendard] text-xl md:text-2xl leading-relaxed flex-1 flex-wrap">
